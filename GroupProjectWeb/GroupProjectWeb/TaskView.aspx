<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="TaskView.aspx.cs" Inherits="TaskView" %>
...
<telerik:RadGrid RenderMode="Lightweight" runat="server" ID="RadGrid1" AutoGenerateColumns="False" AllowPaging="True"
    ...
    >
    <mastertableview datakeynames="TaskID" commanditemdisplay="Top" insertitempageindexaction="ShowItemOnCurrentPage">
        <CommandItemSettings ShowAddNewRecordButton="false" />
  <Columns>
    <telerik:GridEditCommandColumn ButtonType="ImageButton" />
    <telerik:GridBoundColumn DataField="TaskID" HeaderText="Task ID" ReadOnly="true"
    ...
    <telerik:GridBoundColumn DataField="TaskNotes" HeaderText="Task Notes" />
    <telerik:GridBoundColumn DataField="Iteration" HeaderText="Iteration" />
      ...
      <telerik:GridBoundColumn DataField="CompletionPercent" HeaderText="Percent Completed" />
      <telerik:GridBoundColumn DataField="Status" HeaderText="Status" />

    <telerik:GridButtonColumn ConfirmText="Delete this Task?" ConfirmDialogType="RadWindow"
